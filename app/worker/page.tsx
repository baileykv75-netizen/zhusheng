...
export default function WorkerPage() {
  ...
  return (
    <SceneStage view="worker" focus="pipe-joint" activeFlow={recording && !paused} cues={[{ id: "component", label: "W-1602-B7", detail: "PPR DN20支管接头", x: 30, y: 45, tone: stage >= 4 ? "safe" : "water" }]}>
